  ...
  return (ChildComponent, L2, E2) => {
    ...
    const Container = class extends React.Component {
      ...
      componentWillReceiveProps(props) {
        this._propsChanged = !shallowEqual(props, this.props);
        this._subscribe(props);
      }
      ...
      shouldComponentUpdate() {
        ...
        if (this._payloadChanged || this._propsChanged) {
          return true;
        }
      ...
      _subscribe(props) {
        ...
        this._stop = fn(props, (error, payload) => {
          ...
          // check whether payload changed or not.
          if (error) {
            const oldError = this.state.error;
            this._payloadChanged = error !== oldError;
          } else {
            const oldFnData = this.state._fnData;
            this._payloadChanged = !shallowEqual(oldFnData.payload, payload);
          }
